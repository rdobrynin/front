...
<div class="block" style="padding-bottom: 0">
    <div class="container-fluid">
        <div class="breadcrumbs">
            <a href="index.php">Dashboard&nbsp;</a><span class="ts-icon-breadcrumb-arrow"></span>Create virtual machine
        </div>
    </div>
</div>
  <div class="legend"><h2>Create virtual machine</h2></div>
<div class="container-fluid tab-container">
    <ul class="nav nav-tabs" id="createTab">
        <li class="active first-tab"><a href="#create-vm-1-tab">1. Templates</a></li>
        <li><a href="#create-vm-2-tab">2. Resources & Properties</a></li>
        <li><a href="#create-vm-3-tab">3. Confirmation</a></li>
    </ul>
</div>
<div class="container-fluid wrapper">
    <div class="tab-content">
        <div class="tab-pane active" id="create-vm-1-tab">
            <h4>1. Templates</h4>
            <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames
                ac turpis egestas.</p>
        </div>
        <div class="tab-pane" id="create-vm-2-tab">
            <h4>2. Resources & Properties</h4>
            <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames
                ac turpis egestas.</p>
        </div>
        <div class="tab-pane" id="create-vm-3-tab">
